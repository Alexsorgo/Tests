...
from tests.model.element import Element
...
class WheelView:
    ...
    def tap_myself_chat(self):
        ...
        self.get_first_level_item(tests.enums.wheel_enums.MYSELF, tests.enums.wheel_enums.FIRST_LVL)

    def tap_contacts(self):
        log.debug("Tap '{}' button on wheel".format("Contacts"))
        self.get_first_level_item(tests.enums.wheel_enums.CONTACTS, tests.enums.wheel_enums.FIRST_LVL)

    def tap_new_contacts(self):
        log.debug("Tap '{}' button on wheel".format("New contact"))
        self.get_second_level_item(tests.enums.wheel_enums.NEW_CONTACT, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CONTACTS_LVL_ITEM_LIST)

    def tap_add_by_number(self):
        log.debug("Tap '{}' button on wheel".format("Add contact by number"))
        self.get_second_level_item(tests.enums.wheel_enums.BY_NUMBER, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CONTACTS_LVL_ITEM_LIST)

    def tap_add_by_username(self):
        log.debug("Tap '{}' button on wheel".format("Add contact by username"))
        self.get_second_level_item(tests.enums.wheel_enums.BY_USERNAME, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CONTACTS_LVL_ITEM_LIST)

    def tap_add_by_contacts(self):
        log.debug("Tap '{}' button on wheel".format("Add contact by phone book"))
        self.get_second_level_item(tests.enums.wheel_enums.BY_CONTACTS, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CONTACTS_LVL_ITEM_LIST)

    def tap_edit_profile(self):
        log.debug("Tap '{}' button on wheel".format("Edit profile"))
        self.get_second_level_item(tests.enums.wheel_enums.EDIT_PROFILE, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.EDIT_PROFILE_ITEM_LIST)

    def tap_edit_username(self):
        log.debug("Tap '{}' button on wheel".format("Edit username"))
        self.get_second_level_item(tests.enums.wheel_enums.MY_USERNAME, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.EDIT_PROFILE_ITEM_LIST)

    def tap_edit_name(self):
        log.debug("Tap '{}' button on wheel".format("Edit name"))
        self.get_second_level_item(tests.enums.wheel_enums.MY_NAME, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.EDIT_PROFILE_ITEM_LIST)

    def tap_edit_photo(self):
        log.debug("Tap '{}' button on wheel".format("Edit photo"))
        self.get_second_level_item(tests.enums.wheel_enums.MY_PHOTO, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.EDIT_PROFILE_ITEM_LIST)
    ...
    def tap_media(self):
        ...
        self.get_second_level_item(tests.enums.wheel_enums.MEDIA, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CHAT_ACTIONS_LVL_ITEM_LIST)
    ...
    def tap_camera_wheel(self):
        ...
        self.get_second_level_item(tests.enums.wheel_enums.CAMERA, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CHAT_ACTIONS_LVL_ITEM_LIST)

    def tap_location(self):
        log.debug("Tap '{}' button on wheel".format("Location"))
        self.get_second_level_item(tests.enums.wheel_enums.LOCATION, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.CHAT_ACTIONS_LVL_ITEM_LIST)
    ...
    def tap_groups(self):
        ...
        self.get_first_level_item(tests.enums.wheel_enums.GROUPS, tests.enums.wheel_enums.FIRST_LVL)

    def tap_new_group(self):
        log.debug("Tap '{}' button on wheel".format("New group"))
        self.get_second_level_item(tests.enums.wheel_enums.NEW_GROUP, tests.enums.wheel_enums.SECOND_LVL,
                                   tests.enums.wheel_enums.GROUPS_LVL_ITEM_LIST)
