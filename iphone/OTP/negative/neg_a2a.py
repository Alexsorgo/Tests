...
def wrong_sms(self, login, password):
    try:
        ...
        if lang == 0:
            ...
            conf.click()
            self.assertTrue(self.driver.find_element_by_id('Confirmation code is incorrect'))
            ...
            conf.click()
            self.assertTrue(self.driver.find_element_by_id('Неверный код подтверждения'))
            ...
            conf.click()
            self.assertTrue(self.driver.find_element_by_id('Невірний код підтвердження'))
