...
def empty_psw(self, login, password):
    try:
        # f_id = first_id()
        lang = 0
        while lang < 3:
        ...
        if lang == 0:
            ...
            conf.click()
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id('Please, enter the value for "New password"'))
            self.driver.find_element_by_id('OK').click()
            ...
            conf.click()
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id('Пожалуйста, введите значение для "Новый пароль"'))
            self.driver.find_element_by_id('OK').click()
            new_psw.send_keys(123)
            conf.click()
            sleep(3)
            ...
            conf.click()
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id('Будь ласка, введіть значення для "Новий пароль"'))
            self.driver.find_element_by_id('OK').click()
            new_psw.send_keys(123)
            conf.click()
            sleep(3)
