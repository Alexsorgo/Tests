...
def same_log(self, login, password):
    ...
    try:
        ...
        if lang == 0:
            ...
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id("Values of new login and current login must be different."))
            ...
            self.driver.find_element_by_id('navBarOk').click()
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id("Новый логин должен отличаться от текущего"))
            ...
            self.driver.find_element_by_id('navBarOk').click()
            sleep(3)
            self.assertTrue(self.driver.find_element_by_id("Новий логін повинен відрізнятися від поточного"))
